          ...
          <CreateRoutineContext.Provider value={creatingRoutine}>
            <NativeRouter>
              <Stack style={{ alignItems: 'flex-start' }}>
                <ProtectedRoute authenticated={authenticated} exact={true} path="/" component={HomeScreen} />
                <ProtectedRoute authenticated={authenticated} exact={true} path="/Workout" component={WorkoutScreen} />
                <ProtectedRoute
