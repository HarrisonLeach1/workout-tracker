...
const LoginScreen: React.FC<ILoginScreenProps> = ({ theme }) => (
  <Background>
    ...
    <Text style={{ ...styles.text, color: theme.colors.accent }}>{"Welcome.\n Login to start using Workout Tracker."}</Text>
    <Button style={styles.button} labelStyle={styles.buttonText} mode="contained" onPress={() => Auth.federatedSignIn()}>
      Login
    </Button>
    <Button
